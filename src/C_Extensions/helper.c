...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "src.C_Extensions.helper", 
        "sources": [
            "src/C_Extensions/helper.pyx"
        ]
    }, 
    "module_name": "src.C_Extensions.helper"
}
END: Cython Metadata */
...
#define __PYX_HAVE__src__C_Extensions__helper
#define __PYX_HAVE_API__src__C_Extensions__helper
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_3src_12C_Extensions_6helper_DTYPE_t;

/* "src/C_Extensions/helper.pyx":10
 * DTYPE8 = np.int8
 * ctypedef np.float64_t DTYPE_t
 * ctypedef np.int64_t DTYPE64_t             # <<<<<<<<<<<<<<
 * ctypedef np.int8_t DTYPE8_t
 * 
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_3src_12C_Extensions_6helper_DTYPE64_t;

/* "src/C_Extensions/helper.pyx":11
 * ctypedef np.float64_t DTYPE_t
 * ctypedef np.int64_t DTYPE64_t
 * ctypedef np.int8_t DTYPE8_t             # <<<<<<<<<<<<<<
 * 
 * 
 */
typedef __pyx_t_5numpy_int8_t __pyx_t_3src_12C_Extensions_6helper_DTYPE8_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_long__const__(PyObject *, int writable_flag);
...
static void __pyx_f_3src_12C_Extensions_6helper_inner_loop_felsenstein(__Pyx_memviewslice, __Pyx_memviewslice, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "src.C_Extensions.helper"
extern int __pyx_module_is_main_src__C_Extensions__helper;
int __pyx_module_is_main_src__C_Extensions__helper = 0;

/* Implementation of 'src.C_Extensions.helper' */
...
static const char __pyx_k_matrix_left[] = "matrix_left";
static const char __pyx_k_output_view[] = "output_view";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_matrix_right[] = "matrix_right";
...
static const char __pyx_k_state_probs_left[] = "state_probs_left";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_state_probs_right[] = "state_probs_right";
...
static PyObject *__pyx_n_s_matrix_left;
static PyObject *__pyx_n_s_matrix_right;
...
static PyObject *__pyx_n_s_state_probs_left;
static PyObject *__pyx_n_s_state_probs_right;
...
static PyObject *__pyx_pf_3src_12C_Extensions_6helper_array_creation(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vec1, __Pyx_memviewslice __pyx_v_vec2, __Pyx_memviewslice __pyx_v_ind1, __Pyx_memviewslice __pyx_v_ind2, __Pyx_memviewslice __pyx_v_output_view); /* proto */
static PyObject *__pyx_pf_3src_12C_Extensions_6helper_2inner_loop_felsenstein(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_state_probs_left, __Pyx_memviewslice __pyx_v_state_probs_right, int __pyx_v_size, __Pyx_memviewslice __pyx_v_matrix_left, __Pyx_memviewslice __pyx_v_matrix_right, __Pyx_memviewslice __pyx_v_result); /* proto */
...
/* "src/C_Extensions/helper.pyx":23
...
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_1array_creation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_3src_12C_Extensions_6helper_array_creation(__Pyx_memviewslice __pyx_v_vec1, __Pyx_memviewslice __pyx_v_vec2, __Pyx_memviewslice __pyx_v_ind1, __Pyx_memviewslice __pyx_v_ind2, __Pyx_memviewslice __pyx_v_output_view, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __Pyx_RefNannySetupContext("array_creation", 0);

  /* "src/C_Extensions/helper.pyx":25
 * cpdef void array_creation(const double[:] vec1, const double[:] vec2, const long[:] ind1, const long[:] ind2, double[:,:] output_view):
 * 
 *     cdef int o = len(ind1)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_ind1); 
  __pyx_v_o = __pyx_t_1;

  /* "src/C_Extensions/helper.pyx":30
 *     # vec 1 is frequency
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_4 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_x) lastprivate(__pyx_v_y)
                    #endif /* _OPENMP */
                    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_4; __pyx_t_3++){
                        {
                            ...
                            /* "src/C_Extensions/helper.pyx":31
 *     # vec 2 is evolutionary rate
 *     for i in prange(o, nogil=True):
 *         x = ind1[i]             # <<<<<<<<<<<<<<
 *         y = ind2[i]
 ...
 */
                            __pyx_t_5 = __pyx_v_i;
                            __pyx_v_x = (*((long const  *) ( /* dim=0 */ (__pyx_v_ind1.data + __pyx_t_5 * __pyx_v_ind1.strides[0]) )));

                            /* "src/C_Extensions/helper.pyx":32
 *     for i in prange(o, nogil=True):
 *         x = ind1[i]
 *         y = ind2[i]             # <<<<<<<<<<<<<<
 *         # set upper triangle
 ...
 */
                            __pyx_t_6 = __pyx_v_i;
                            __pyx_v_y = (*((long const  *) ( /* dim=0 */ (__pyx_v_ind2.data + __pyx_t_6 * __pyx_v_ind2.strides[0]) )));

                            /* "src/C_Extensions/helper.pyx":34
 *         y = ind2[i]
 *         # set upper triangle
 *         output_view[x][y] = vec1[y]*vec2[i]             # <<<<<<<<<<<<<<
 *         # set lower triangle
 ...
 */
                            ...
                            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output_view.data + __pyx_t_9 * __pyx_v_output_view.strides[0]) ) + __pyx_t_10 * __pyx_v_output_view.strides[1]) )) = ((*((double const  *) ( /* dim=0 */ (__pyx_v_vec1.data + __pyx_t_7 * __pyx_v_vec1.strides[0]) ))) * (*((double const  *) ( /* dim=0 */ (__pyx_v_vec2.data + __pyx_t_8 * __pyx_v_vec2.strides[0]) ))));

                            /* "src/C_Extensions/helper.pyx":36
 *         output_view[x][y] = vec1[y]*vec2[i]
 *         # set lower triangle
 *         output_view[y][x] = vec1[x]*vec2[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            ...
                            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output_view.data + __pyx_t_13 * __pyx_v_output_view.strides[0]) ) + __pyx_t_14 * __pyx_v_output_view.strides[1]) )) = ((*((double const  *) ( /* dim=0 */ (__pyx_v_vec1.data + __pyx_t_11 * __pyx_v_vec1.strides[0]) ))) * (*((double const  *) ( /* dim=0 */ (__pyx_v_vec2.data + __pyx_t_12 * __pyx_v_vec2.strides[0]) ))));
                        }
                    }
                }
            }
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_1array_creation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_1array_creation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("array_creation (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_vec1,&__pyx_n_s_vec2,&__pyx_n_s_ind1,&__pyx_n_s_ind2,&__pyx_n_s_output_view,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_vec2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("array_creation", 1, 5, 5, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ind1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("array_creation", 1, 5, 5, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ind2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("array_creation", 1, 5, 5, 3); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output_view)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("array_creation", 1, 5, 5, 4); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "array_creation") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    ...
    __pyx_v_vec1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double__const__(values[0], 0); if (unlikely(!__pyx_v_vec1.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_vec2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double__const__(values[1], 0); if (unlikely(!__pyx_v_vec2.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_ind1 = __Pyx_PyObject_to_MemoryviewSlice_ds_long__const__(values[2], 0); if (unlikely(!__pyx_v_ind1.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_ind2 = __Pyx_PyObject_to_MemoryviewSlice_ds_long__const__(values[3], 0); if (unlikely(!__pyx_v_ind2.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_output_view = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output_view.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("array_creation", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.C_Extensions.helper.array_creation", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3src_12C_Extensions_6helper_array_creation(__pyx_self, __pyx_v_vec1, __pyx_v_vec2, __pyx_v_ind1, __pyx_v_ind2, __pyx_v_output_view);
...
static PyObject *__pyx_pf_3src_12C_Extensions_6helper_array_creation(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vec1, __Pyx_memviewslice __pyx_v_vec2, __Pyx_memviewslice __pyx_v_ind1, __Pyx_memviewslice __pyx_v_ind2, __Pyx_memviewslice __pyx_v_output_view) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("array_creation", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_vec1.memview)) { __Pyx_RaiseUnboundLocalError("vec1"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_vec2.memview)) { __Pyx_RaiseUnboundLocalError("vec2"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ind1.memview)) { __Pyx_RaiseUnboundLocalError("ind1"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ind2.memview)) { __Pyx_RaiseUnboundLocalError("ind2"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_output_view.memview)) { __Pyx_RaiseUnboundLocalError("output_view"); __PYX_ERR(0, 23, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_3src_12C_Extensions_6helper_array_creation(__pyx_v_vec1, __pyx_v_vec2, __pyx_v_ind1, __pyx_v_ind2, __pyx_v_output_view, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
...
/* "src/C_Extensions/helper.pyx":40
 * @cython.wraparound(False)
 * @cython.boundscheck(False)
...
static double __pyx_f_3src_12C_Extensions_6helper_dot(__Pyx_memviewslice __pyx_v_vec, __Pyx_memviewslice __pyx_v_vec2, CYTHON_UNUSED int const __pyx_v_m) {
  Py_ssize_t __pyx_v_i;
  double __pyx_v_res;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "src/C_Extensions/helper.pyx":42
 * cdef double dot(const double[:] vec, const double[:] vec2, const int m):
 *     cdef ssize_t i
 *     cdef double res = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/C_Extensions/helper.pyx":44
 *     cdef double res = 0.0
 * 
 *     for i in prange(m, nogil=True):             # <<<<<<<<<<<<<<
 *         res += vec[i]*vec2[i]
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_res) private(__pyx_t_4, __pyx_t_5)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    ...
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            ...
                            /* "src/C_Extensions/helper.pyx":45
 * 
 *     for i in prange(m, nogil=True):
 *         res += vec[i]*vec2[i]             # <<<<<<<<<<<<<<
 *     return res
 ...
 */
                            __pyx_t_4 = __pyx_v_i;
                            __pyx_t_5 = __pyx_v_i;
                            __pyx_v_res = (__pyx_v_res + ((*((double const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_4 * __pyx_v_vec.strides[0]) ))) * (*((double const  *) ( /* dim=0 */ (__pyx_v_vec2.data + __pyx_t_5 * __pyx_v_vec2.strides[0]) )))));
                        }
                    }
                }
            }
 ...
 */
  ...
  /* "src/C_Extensions/helper.pyx":46
 *     for i in prange(m, nogil=True):
 *         res += vec[i]*vec2[i]
 *     return res             # <<<<<<<<<<<<<<
 * 
...
/* "src/C_Extensions/helper.pyx":51
 * @cython.wraparound(False)
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_3inner_loop_felsenstein(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_3src_12C_Extensions_6helper_inner_loop_felsenstein(__Pyx_memviewslice __pyx_v_state_probs_left, __Pyx_memviewslice __pyx_v_state_probs_right, CYTHON_UNUSED int __pyx_v_size, __Pyx_memviewslice __pyx_v_matrix_left, __Pyx_memviewslice __pyx_v_matrix_right, __Pyx_memviewslice __pyx_v_result, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_index;
  double __pyx_v_l_z;
  double __pyx_v_l_o;
  double __pyx_v_r_z;
  ...
  __Pyx_RefNannySetupContext("inner_loop_felsenstein", 0);

  /* "src/C_Extensions/helper.pyx":60
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_22, __pyx_t_23, __pyx_t_24, __pyx_t_25, __pyx_t_26, __pyx_t_27, __pyx_t_28, __pyx_t_29, __pyx_t_30, __pyx_t_31, __pyx_t_32, __pyx_t_33, __pyx_t_34, __pyx_t_35, __pyx_t_36, __pyx_t_37, __pyx_t_38, __pyx_t_39, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_index) lastprivate(__pyx_v_index) lastprivate(__pyx_v_l_o) lastprivate(__pyx_v_l_z) lastprivate(__pyx_v_r_o) lastprivate(__pyx_v_r_z)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_index = (int)(0 + 1 * __pyx_t_2);
                            /* Initialize private variables to invalid values */
                            __pyx_v_l_o = ((double)__PYX_NAN());
                            __pyx_v_l_z = ((double)__PYX_NAN());
                            __pyx_v_r_o = ((double)__PYX_NAN());
                            __pyx_v_r_z = ((double)__PYX_NAN());

                            /* "src/C_Extensions/helper.pyx":61
 * 
 *         for index in prange(size, nogil = True):
 *             l_z = (state_probs_left[index][0] * matrix_left[0][0]) + (state_probs_left[index][1] * matrix_left[1][0])             # <<<<<<<<<<<<<<
 *             l_o = (state_probs_left[index][1] * matrix_left[1][1]) + (state_probs_left[index][0] * matrix_left[0][1])
 ...
 */
                            ...
                            __pyx_t_10 = 1;
                            __pyx_t_11 = 0;
                            __pyx_v_l_z = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_left.data + __pyx_t_4 * __pyx_v_state_probs_left.strides[0]) ) + __pyx_t_5 * __pyx_v_state_probs_left.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_left.data + __pyx_t_6 * __pyx_v_matrix_left.strides[0]) ) + __pyx_t_7 * __pyx_v_matrix_left.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_left.data + __pyx_t_8 * __pyx_v_state_probs_left.strides[0]) ) + __pyx_t_9 * __pyx_v_state_probs_left.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_left.data + __pyx_t_10 * __pyx_v_matrix_left.strides[0]) ) + __pyx_t_11 * __pyx_v_matrix_left.strides[1]) )))));

                            /* "src/C_Extensions/helper.pyx":62
 *         for index in prange(size, nogil = True):
 *             l_z = (state_probs_left[index][0] * matrix_left[0][0]) + (state_probs_left[index][1] * matrix_left[1][0])
 *             l_o = (state_probs_left[index][1] * matrix_left[1][1]) + (state_probs_left[index][0] * matrix_left[0][1])             # <<<<<<<<<<<<<<
 *             r_z = (state_probs_right[index][0] * matrix_right[0][0]) + (state_probs_right[index][1] * matrix_right[1][0])
 ...
 */
                            ...
                            __pyx_t_18 = 0;
                            __pyx_t_19 = 1;
                            __pyx_v_l_o = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_left.data + __pyx_t_12 * __pyx_v_state_probs_left.strides[0]) ) + __pyx_t_13 * __pyx_v_state_probs_left.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_left.data + __pyx_t_14 * __pyx_v_matrix_left.strides[0]) ) + __pyx_t_15 * __pyx_v_matrix_left.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_left.data + __pyx_t_16 * __pyx_v_state_probs_left.strides[0]) ) + __pyx_t_17 * __pyx_v_state_probs_left.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_left.data + __pyx_t_18 * __pyx_v_matrix_left.strides[0]) ) + __pyx_t_19 * __pyx_v_matrix_left.strides[1]) )))));

                            /* "src/C_Extensions/helper.pyx":63
 *             l_z = (state_probs_left[index][0] * matrix_left[0][0]) + (state_probs_left[index][1] * matrix_left[1][0])
 *             l_o = (state_probs_left[index][1] * matrix_left[1][1]) + (state_probs_left[index][0] * matrix_left[0][1])
 *             r_z = (state_probs_right[index][0] * matrix_right[0][0]) + (state_probs_right[index][1] * matrix_right[1][0])             # <<<<<<<<<<<<<<
 *             r_o = (state_probs_right[index][1] * matrix_right[1][1]) + (state_probs_right[index][0] * matrix_right[0][1])
 ...
 */
                            ...
                            __pyx_t_26 = 1;
                            __pyx_t_27 = 0;
                            __pyx_v_r_z = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_right.data + __pyx_t_20 * __pyx_v_state_probs_right.strides[0]) ) + __pyx_t_21 * __pyx_v_state_probs_right.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_right.data + __pyx_t_22 * __pyx_v_matrix_right.strides[0]) ) + __pyx_t_23 * __pyx_v_matrix_right.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_right.data + __pyx_t_24 * __pyx_v_state_probs_right.strides[0]) ) + __pyx_t_25 * __pyx_v_state_probs_right.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_right.data + __pyx_t_26 * __pyx_v_matrix_right.strides[0]) ) + __pyx_t_27 * __pyx_v_matrix_right.strides[1]) )))));

                            /* "src/C_Extensions/helper.pyx":64
 *             l_o = (state_probs_left[index][1] * matrix_left[1][1]) + (state_probs_left[index][0] * matrix_left[0][1])
 *             r_z = (state_probs_right[index][0] * matrix_right[0][0]) + (state_probs_right[index][1] * matrix_right[1][0])
 *             r_o = (state_probs_right[index][1] * matrix_right[1][1]) + (state_probs_right[index][0] * matrix_right[0][1])             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            ...
                            __pyx_t_34 = 0;
                            __pyx_t_35 = 1;
                            __pyx_v_r_o = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_right.data + __pyx_t_28 * __pyx_v_state_probs_right.strides[0]) ) + __pyx_t_29 * __pyx_v_state_probs_right.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_right.data + __pyx_t_30 * __pyx_v_matrix_right.strides[0]) ) + __pyx_t_31 * __pyx_v_matrix_right.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state_probs_right.data + __pyx_t_32 * __pyx_v_state_probs_right.strides[0]) ) + __pyx_t_33 * __pyx_v_state_probs_right.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_right.data + __pyx_t_34 * __pyx_v_matrix_right.strides[0]) ) + __pyx_t_35 * __pyx_v_matrix_right.strides[1]) )))));

                            /* "src/C_Extensions/helper.pyx":66
 *             r_o = (state_probs_right[index][1] * matrix_right[1][1]) + (state_probs_right[index][0] * matrix_right[0][1])
 * 
 *             result[index][0] = l_z * r_z             # <<<<<<<<<<<<<<
 ...
 */
                            ...
                            __pyx_t_37 = 0;
                            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result.data + __pyx_t_36 * __pyx_v_result.strides[0]) ) + __pyx_t_37 * __pyx_v_result.strides[1]) )) = (__pyx_v_l_z * __pyx_v_r_z);

                            /* "src/C_Extensions/helper.pyx":67
 * 
 *             result[index][0] = l_z * r_z
 *             result[index][1] = l_o * r_o             # <<<<<<<<<<<<<<
 */
                            ...
                            __pyx_t_39 = 1;
                            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result.data + __pyx_t_38 * __pyx_v_result.strides[0]) ) + __pyx_t_39 * __pyx_v_result.strides[1]) )) = (__pyx_v_l_o * __pyx_v_r_o);
                        }
                    }
                }
            }
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_3inner_loop_felsenstein(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3src_12C_Extensions_6helper_3inner_loop_felsenstein(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_state_probs_left = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_state_probs_right = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_size;
  __Pyx_memviewslice __pyx_v_matrix_left = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_matrix_right = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inner_loop_felsenstein (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_state_probs_left,&__pyx_n_s_state_probs_right,&__pyx_n_s_size,&__pyx_n_s_matrix_left,&__pyx_n_s_matrix_right,&__pyx_n_s_result,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_state_probs_left)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_state_probs_right)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, 1); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, 2); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_matrix_left)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, 3); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_matrix_right)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, 4); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_result)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, 5); __PYX_ERR(0, 51, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inner_loop_felsenstein") < 0)) __PYX_ERR(0, 51, __pyx_L3_error)
      }
    ...
    __pyx_v_state_probs_left = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_state_probs_left.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_state_probs_right = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_state_probs_right.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_matrix_left = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_matrix_left.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_matrix_right = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_matrix_right.memview)) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_result = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_result.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inner_loop_felsenstein", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 51, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.C_Extensions.helper.inner_loop_felsenstein", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3src_12C_Extensions_6helper_2inner_loop_felsenstein(__pyx_self, __pyx_v_state_probs_left, __pyx_v_state_probs_right, __pyx_v_size, __pyx_v_matrix_left, __pyx_v_matrix_right, __pyx_v_result);
...
static PyObject *__pyx_pf_3src_12C_Extensions_6helper_2inner_loop_felsenstein(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_state_probs_left, __Pyx_memviewslice __pyx_v_state_probs_right, int __pyx_v_size, __Pyx_memviewslice __pyx_v_matrix_left, __Pyx_memviewslice __pyx_v_matrix_right, __Pyx_memviewslice __pyx_v_result) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("inner_loop_felsenstein", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_state_probs_left.memview)) { __Pyx_RaiseUnboundLocalError("state_probs_left"); __PYX_ERR(0, 51, __pyx_L1_error) }
  if (unlikely(!__pyx_v_state_probs_right.memview)) { __Pyx_RaiseUnboundLocalError("state_probs_right"); __PYX_ERR(0, 51, __pyx_L1_error) }
  if (unlikely(!__pyx_v_matrix_left.memview)) { __Pyx_RaiseUnboundLocalError("matrix_left"); __PYX_ERR(0, 51, __pyx_L1_error) }
  if (unlikely(!__pyx_v_matrix_right.memview)) { __Pyx_RaiseUnboundLocalError("matrix_right"); __PYX_ERR(0, 51, __pyx_L1_error) }
  if (unlikely(!__pyx_v_result.memview)) { __Pyx_RaiseUnboundLocalError("result"); __PYX_ERR(0, 51, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_3src_12C_Extensions_6helper_inner_loop_felsenstein(__pyx_v_state_probs_left, __pyx_v_state_probs_right, __pyx_v_size, __pyx_v_matrix_left, __pyx_v_matrix_right, __pyx_v_result, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_state_probs_left, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_state_probs_right, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_matrix_left, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_matrix_right, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "src.C_Extensions.helper.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.C_Extensions.helper.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.C_Extensions.helper.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.C_Extensions.helper._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"array_creation", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3src_12C_Extensions_6helper_1array_creation, METH_VARARGS|METH_KEYWORDS, 0},
  {"inner_loop_felsenstein", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3src_12C_Extensions_6helper_3inner_loop_felsenstein, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_matrix_left, __pyx_k_matrix_left, sizeof(__pyx_k_matrix_left), 0, 0, 1, 1},
  {&__pyx_n_s_matrix_right, __pyx_k_matrix_right, sizeof(__pyx_k_matrix_right), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_state_probs_left, __pyx_k_state_probs_left, sizeof(__pyx_k_state_probs_left), 0, 0, 1, 1},
  {&__pyx_n_s_state_probs_right, __pyx_k_state_probs_right, sizeof(__pyx_k_state_probs_right), 0, 0, 1, 1},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("dot", (void (*)(void))__pyx_f_3src_12C_Extensions_6helper_dot, "double (__Pyx_memviewslice, __Pyx_memviewslice, int const )") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("array_creation", (void (*)(void))__pyx_f_3src_12C_Extensions_6helper_array_creation, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("inner_loop_felsenstein", (void (*)(void))__pyx_f_3src_12C_Extensions_6helper_inner_loop_felsenstein, "void (__Pyx_memviewslice, __Pyx_memviewslice, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_src__C_Extensions__helper) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.C_Extensions.helper")) {
      if (unlikely(PyDict_SetItemString(modules, "src.C_Extensions.helper", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int64); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE64, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "src/C_Extensions/helper.pyx":8
 * DTYPE = np.float64
 * DTYPE64 = np.int64
 * DTYPE8 = np.int8             # <<<<<<<<<<<<<<
 * ctypedef np.float64_t DTYPE_t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_int8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE8, __pyx_t_2) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "src/C_Extensions/helper.pyx":2
 * 
 * from cython.parallel import prange             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.C_Extensions.helper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.C_Extensions.helper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_ds_long__const__(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
